...
Kp_slider = tk.Scale(slider_frame, from_=0, to=500, orient=tk.HORIZONTAL, command= set_Kp, resolution=0.01, length=400, label="Kp")
Kp_slider.set(Kp)
Kp_slider.pack()
...
Kd_slider = tk.Scale(slider_frame, from_=0, to=200, orient=tk.HORIZONTAL, command= set_Kd, resolution=0.01, length=400, label="Kd")
Kd_slider.set(Kd)
Kd_slider.pack()
